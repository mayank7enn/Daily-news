...
const Navbar = () => {
  return (
    <nav className="navbar sticky-top navbar-expand-lg " style={{backgroundColor:'#070F2B'}}>
      <div className="container-fluid" >
        <Link className="navbar-brand"  style={{color:'#F7EFE5', fontFamily: 'sans-serif'}} to="/">Daily News</Link>
